...
--
-- Servidor: localhost
-- Tiempo de generación: 22-04-2014 a las 05:41:43
...
CREATE TABLE `tbl_usuarios` (
  ...
  PRIMARY KEY (`id_user`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Tabla de datos usuarios' AUTO_INCREMENT=12 ;
...
(2, 'Luis Fernando', 'Desarrollo Web', 'Wonka', 'Suspendido'),
(3, 'Carlos García H', 'Desarrollo Web', 'Wonka', 'Suspendido'),
(7, 'Luis Fernando Cázares', 'Desarrollo Web', 'CazaresLuis', 'Activo'),
(8, 'Luis Fernando', 'Desarrollo Web', 'CazaresLuis', 'Activo'),
(10, 'Luis Fernando Cázares', 'Desarrollo Web', 'cazaresluis', 'Suspendido'),
(11, 'Carlos García Gómez', 'Desarrollo Web', 'Wonka', 'Activo');
